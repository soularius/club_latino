                                    ...
                                    <table class="es-content" cellspacing="0" cellpadding="0" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%">
                                        <tr>
                                            <td align="center" style="padding:0;Margin:0">
                                                <table class="es-content-body" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#ffffff;background-repeat:no-repeat;width:800px;background-image:url(' . $home_url . '/wp-content/uploads/2023/03/rectangle_26.png);background-position:center top" cellspacing="0" cellpadding="0" bgcolor="#ffffff" background="' . $home_url . '/wp-content/uploads/2023/03/rectangle_26.png" align="center">
                                                    <tr>
                                                                        ...
                                                                        <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                            <tr>
                                                                                <td align="center" style="padding:0;Margin:0;padding-bottom:20px">
                                                                                    <h2 style="Margin:0;line-height:43px;mso-line-height-rule:exactly;font-family:Orbitron, sans-serif;font-size:36px;font-style:normal;font-weight:bold;color:#10054D">Hola, ' . $name . ' esta invitad@ al evento: ' . $title . '<br></h2>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="left" style="padding:0;Margin:0;padding-bottom:15px;padding-top:20px">
                                                                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                                        ...
                                                                                        <strong>Fecha:</strong>&nbsp;' . $data  . '<br>
                                                                                        <strong>Hora de Inicio:</strong>&nbsp;' . $hora_inicio . '<br>
                                                                                        <strong>Hora de Fin / Equipo</strong>:&nbsp;' . $hora_fin . '<br>
                                                                                        <strong>Ver detalle:</strong>&nbsp;<a href="' . $link . '">Ir al evento</a><br>
                                                                                        <strong>Actividades:</strong><br>
                                                                                    </p>
                                                                                    <div style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                                        &nbsp;' . $html_table . '
                                                                                        <br>
                                                                                    </div>
                                                                                </td>
